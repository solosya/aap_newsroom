import { LoadBlogArticles } from './sdk/blogFeed'
...
Feed.prototype.fetch = function()
{
    ...
    LoadBlogArticles(self.options).done(function(data) {
        if (data.success == 1) {
            self.render(data);
        }
    });
...
export const ArticleFeed = function(feedModel, limit, offset, infinite, failText, controller)
{
    console.log('making an articleFeed!!!');
